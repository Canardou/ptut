...
public class Movement {
	...
	public static final double RIGHTWALL_DIST 	= 13;  // Distance à laquelle le robot va longer le mur
	public static final double RIGHTWALL_ERR 	= 0;   // Erreur permise, défini une bande à RIGHTWALL_DIST +- RIGHTWALL_ERR du mur droit dans laquelle le robot doit rouler
	public static final double RIGHTWALL_GAIN 	= 3;   // Gain du régulateur P pour longer le mur
	public static final double RIGHTWALL_TIME	= 800;// Régule la position par rapport au mur droit tout les RIGHTWALL_REG cm.

	// Paramètres de vitesse
	public static final double SPEED_CRUISE		= 20; // Vitesse de croisère (38 max)
	public static final double SPEED_DANGER		= 10; // Vitesse à l'approche d'un mur avant
	public static final double FRONTWALL_DANGER = 30; // Distance à partir de laquelle la vitesse est réduite (approche d'un mur avant)
	...
	public static final double RSPEED_DANGER	= 25; // Vitesse de rotation lorsqu'on approche de l'angle désiré
	...
	public void moveForward() {		
		...
		while ( (!this.robot.frontWallDetected) /*|| (distTraveled < UNIT_DIST)*/ ) {
			...
			// s'il s'est écoulé au moins RIGHTWALL_TIME ms depuis la derniere régulation
			if( (System.currentTimeMillis()-time) >= RIGHTWALL_TIME ){
	...
	public void turn(double angle) {
		System.out.println("entree le turn");	
		double err ;
