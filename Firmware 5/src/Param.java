public class Param {
	...
	public static final int	   XN  				= 1;    // Selon les X negatifs
	public static final int	   YP				= 2;    // Selon les Y positifs
	...
	// Capteurs
	public static final int    TAB_NBDATA       = 3;    // Nombre d'échantillon dans le filtre des capteurs
	...
	public static final int    BACKWARD 		= 6;    // Reculer
 	...
 	// Limites
 	public static final double LIMLEFTWALL 		= 25;   // (cm) Limite en dessous de laquelle on considère qu'il y a un mur juste à droite
 	public static final double LIMRIGHTWALL 	= 25;   // (cm) Limite en dessous de laquelle on considère qu'il y a un mur juste à droite
 	public static final double LIMFRONTWALL		= 13;   // (cm) Limite en dessous de laquelle on considère qu'il y a un mur juste devant et qu'on ne doit pas s'approcher plus
	...
	public static final double ANGLE_DANGER		= 19;   // (degrés) Angle relatif à l'objectif à partir duquel la vitesse de rotation est réduite
	...
	public static final double REG_ERRDIST		= 0;    // (cm) erreur permise pour etre bien au milieu des 2 murs
	public static final double REG_ERRANGLEMAX  = 5;    // (degrés) Angle critique à partir duquel l'erreur est considérée trop grande et que l'on doit absolument réguler
	public static final double REG_ERR 			= 1;    // (degrés) Erreur permise sur l'angle de régulation
	public static final double REG_CHECK        = 20;   // (cm) Distance aprés laquelle on vérifie qu'on a un mur devant
	
	public static final double RIGHTWALL_MIN 	= 7;    // (cm) Distance à partir de laquelle le robot va tourner pour s'écarter du mur
	public static final double RIGHTWALL_MAX 	= 8;    // (cm) Distance à partir de laquelle le robot va tourner pour s'approcher du mur
	public static final double RIGHTWALL_ARC1   = 25;   // (cm) Rayon du cercle à suivre pour réguler fortement
	public static final double RIGHTWALL_ARC2   = 45;   // (cm) Rayon du cercle à suivre pour réguler faiblement
	...
	public static final int    MIDLEFTREG       = 4;
	public static final int    MIDRIGHTREG      = 5;
	public static final int    ROTREG			= 6;
