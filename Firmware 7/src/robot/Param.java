...
public class Param {
	...
	// Capteurs
	public static final int    TAB_NBDATA       = 4;    // Nombre d'échantillon dans le filtre des capteurs
	...
	public static final int    BACKWARD 		= 6;    // Reculer
 	...
 	public static final double LIMFRONTWALL		= 12;   // (cm) Limite en dessous de laquelle on considère qu'il y a un mur juste devant et qu'on ne doit pas s'approcher plus
 	public static final double FRONTWALL_DANGER = 20;   // (cm) 
	...
	// Paramètres pour la régulation en avancant
	public static final double REG_ERRDIST		= 2.5;    // (cm) erreur permise pour etre bien au milieu des 2 murs
	public static final double REG_ERRANGLEMAX  = 10;   // (degrés) Angle critique à partir duquel l'erreur est considérée trop grande et que l'on doit absolument réguler
	public static final double REG_ERR 			= 5;    // (degrés) Erreur permise sur l'angle de régulation
	public static final double REG_CHECK        = 25;   // (cm) Distance aprés laquelle on vérifie qu'on a un mur devant
	
	public static final double RIGHTWALL_MIN 	= 6;    // (cm) Distance à partir de laquelle le robot va tourner pour s'écarter du mur
	public static final double RIGHTWALL_MAX 	= 7;    // (cm) Distance à partir de laquelle le robot va tourner pour s'approcher du mur
	public static final double RIGHTWALL_ARC1   = 20;//25;   // (cm) Rayon du cercle à suivre pour réguler fortement
	public static final double RIGHTWALL_ARC2   = 50;//45;   // (cm) Rayon du cercle à suivre pour réguler faiblement
