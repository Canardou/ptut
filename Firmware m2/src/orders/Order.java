...
public class Order {
	...
	/**
	 * Attribut qui fait r�f�rence � la tache principale du robot
	 */
	 ...
	 * @param r
	 *            objet repr�sentant le thread principal du robot
	 */
	 ...
	 * v�rifie que les conditions initiales soit bonnes si on veut deplacer le
	 * robot, i.e. : </br> 1 - La boussole a �t� calibr�e (au moins une fois) ->
	 * ordre CALCOMPASS</br> 2 - L'angle de r�f�rence a �t� enregistr� et la
	 * position du robot a �t� recu (au moins une fois, peu importe l'ordre) ->
	 * ordre SAVEREFANGLE et SETPOSITION</br> 3 - La premiere case a �t� visit�
	 * enti�rement (au moins une fois) -> ordre CHECKFIRSTCASE</br>
	 * 
	 * @see ListOrder
	 * @see Robot#order
	 */
	...
	/**
	 * M�thode de test, algorithme d'exploration basique
	 */
	...
	/**
	 * M�thode de test, permet d'executer n'importe quel ordre sans verifier les
