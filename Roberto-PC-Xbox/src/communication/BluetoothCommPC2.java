...
/*attributs */
	...
	public void sendTrameToNXT(Trame2 trameEnvoyee) throws IOException {
		...
		// si communication OK alors le superviseur envoie la trame � la brique NXT
		...
		//superviseur recoit la trame renvoy�e par la brique pour verifier que c'est la bonne
		...
		// si les deux trames sont identiques alors le superviseur envoie 0 � la brique sinon 1
	...
	public Trame2 receiveTrameNXT() throws IOException, NXTCommException{
		//superviseur re�oit une demande de la brique
		/*try {
...
/*		for (int i=0; i <= trameRecue.length; i++){
		...
		//Si NXT renvoie 0 alors la trame est bonne, la m�thode retourne la trame, sinon elle retourne null
