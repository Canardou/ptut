...
public class Chemin {
	...
	**/
	...
	/**
	 * Retourne vrai si le chemin ne dispose pas de possibilit� de croisement
	 * @param autre
	 * @return
	...
	/**
	 * Compare deux chemins pour savoir s'ils se croisent et s'il existe une possibilit� de croisement.
	 * @param autre
	 * @return
